...
\end{frame}
\note{
Out objective is to appropriately select between continuous and procedural statements. To do that, we need to know in more detail how these two different kinds of assignments work.
